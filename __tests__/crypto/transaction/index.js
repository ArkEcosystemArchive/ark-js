...
test("transaction.js", function () {
  ...
  test("#createTransaction", function () {
    ...
    test("returned transaction", function () {
      it("should be object", function () {
  ...
  test("createTransaction and try to tamper signature", function(){
  ...
  test("#createTransaction with second secret", function () {
    var createTransaction = transaction.createTransaction;
    var trs = null;
