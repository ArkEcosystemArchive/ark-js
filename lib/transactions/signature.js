...
// escrowPublicKey is the value returned by newSignature(escrowSecret)
function createEscrowSignature(secret, escrowPublicKey) {
	var keys = crypto.getKeys(secret);
...
module.exports = {
	...
	createEscrowSignature: createEscrowSignature
}
