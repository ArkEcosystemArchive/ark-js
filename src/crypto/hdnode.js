 ...
 * @returns {HDNode}
 */
HDNode.fromSeedBuffer = (seed, network) => {
 ...
 * @returns {HDNode}
 */
HDNode.fromSeedHex = (hex, network) => {
 ...
 * @returns {Buffer}
 */
HDNode.prototype.getIdentifier = () => {
 ...
 * @returns {Buffer}
 */
HDNode.prototype.getPublicKeyBuffer = () => {
 ...
 * @returns {boolean}
 */
HDNode.prototype.verify = (hash, signature) => {
 ...
 * @returns {HDNode}
 */
HDNode.prototype.deriveHardened = (index) => {
 ...
 * @returns {HDNode}
 */
HDNode.prototype.derivePath = (path) => {
