...
let networkVersion = 0x17 // TODO: move this to the configuration
 ...
 * @returns {Uint8Array}
 */
exports.getSignatureBytes = (signature) => {
 ...
 * @returns {Buffer}
 */
exports.getBytes = (transaction, skipSignature, skipSecondSignature) => {
  let assetSize = 0,
    assetBytes = null
 ...
 * @returns {number}
 */
exports.findAndParseSignatures = (hexString, tx) => {
 ...
 * @returns {Buffer}
 */
exports.getHash = (transaction, skipSignature, skipSecondSignature) => {
...
exports.getKeys = (secret, network) => {
  let ecpair = ECPair.fromSeed(secret, network || networks.ark)
